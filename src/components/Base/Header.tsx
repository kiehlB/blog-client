      ...
      <div className="max-w-9xl mx-auto sm:px-6 m2xl:px-10 mmd:px-4">
        <div className="flex justify-between items-center  border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            <Link href="/">
              <a className="text-base   text-gray-500 hover:text-gray-900  font-bold">
                Blog
              </a>
            </Link>
            <Link href="/about">
                    ...
                    <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                          <div>
                            <h3 className="text-sm tracking-wide font-bold text-gray-500 uppercase">
                              Recent Posts
                            </h3>
          ...
          {!loading && getUser?.me ? (
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 ">
              ...
              <div
                ...
                className="ml-8 cursor-pointer whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-base font-bold text-white bg-regal-sky">
                Sign out
              </div>
            </div>
          ) : (
